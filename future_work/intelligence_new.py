...
PORT_DECEPTION_GENERATOR_ADD_HOST = 5046
...
def deploy_host(controller_ip):
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s3:
            ...
            s3.connect((HOST_DECEPTION_GENERATOR, PORT_DECEPTION_GENERATOR_ADD_HOST))

            params = '{} {} {} {} {} {} {} {}'.format("DG1","h56",data.get('host_ip'),data.get('host_mac'),"ubuntu:trusty","s1",1,2)
